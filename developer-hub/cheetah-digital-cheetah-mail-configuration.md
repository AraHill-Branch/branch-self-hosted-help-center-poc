---
title: "Cheetah Digital Cheetah Mail Configuration"
...
In order to enable Cheetah Mail, you must first:
...
5. Obtain or set up your Cheetah Mail **click tracking domain** (CTD). Reach out to your Cheetah Digital account manager for assistance on this.

## Enable Cheetah Mail

## Connect Cheetah Digital Cheetah Mail Service in Branch
...
The Cheetah Mail integration requires you provide the following:

- **Click Tracking Domain** - The domain you use with Cheetah Mail for links in emails
...
### Add your Cheetah Mail CTD to your Associated Domains
