---
title: "Oracle Bronto Configuration"
...
Marketing Tools for High-Growth Retailers. Sophisticated commerce marketing automation for increased engagement to maximize revenue opportunities.
...
- Developers
- CRM/Email Team
- Oracle Bronto Account Manager / Support Team
:::

In order to enable Bronto, you must first:
...
5. Obtain or set up your Bronto **click tracking domain** (CTD). Reach out to your Bronto account manager for assistance on this.

## Enable Oracle Bronto

## Connect Oracle Bronto Service in Branch
...
The Oracle Bronto integration requires you provide the following:

- **Click Tracking Domain** - The domain you use with Oracle Bronto for links in emails

For additional help, please see Oracle Bronto's [documentation](https://helpdocs.bronto.com/bmp/task/t_bmp_home_data_exchange_link_tracking_set_up.html).
...
### Add your Bronto CTD to your Associated Domains
...
For the email links that you would like to deep link to content, add `deeplink="true"` to the HTML as a query parameter, for example:

```
<a href="https://app.com" deeplink="true">Download the App!</a>
```
