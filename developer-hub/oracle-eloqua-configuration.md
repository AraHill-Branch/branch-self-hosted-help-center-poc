---
title: "Oracle Eloqua Configuration"
...
Eloqua Marketing Automation: Drive Dynamic Journeys. Successful demand generation, email marketing, and lead management engagement hinge on a modern platform and strategy aligned to buyer needs across all phases and channels of the buying process.
...
- Developers
- CRM/Email Team
- Oracle Eloqua Account Manager / Support Team
:::

In order to enable Eloqua, you must first:
...
5. Obtain or set up your Eloqua **click tracking domain** (CTD). Reach out to your Eloqua account manager for assistance on this.

## Enable Oracle Eloqua

## Connect Oracle Eloqua Service in Branch
...
The Oracle Eloqua integration requires you provide the following:

- **Click Tracking Domain** - The domain you use with Oracle Eloqua for links in emails
- **Oracle Eloqua Domain** - The domain Oracle Eloqua uses to collect data
...
### Add your Eloqua CTD to your Associated Domains
