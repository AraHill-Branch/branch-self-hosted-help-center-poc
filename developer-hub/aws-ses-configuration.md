...
In order to enable Amazon Simple Email Service, you must first:
...
For additional help, please see Amazon's [documentation](https://docs.aws.amazon.com/ses/latest/dg/configure-custom-open-click-domains.html).
