---
title: "Adobe Campaign Classic Configuration"
...
In order to enable Adobe Campaign, you must first:
...
## Set up a Custom Click Tracking Domain
...
[How to configure multi-branding in Adobe](https://docs.adobe.com/content/help/en/campaign-classic/using/transactional-messaging/instance-configuration/configuring-multibranding.html)
...
- Open a support ticket with [Enterprise Support](https://helpx.adobe.com/contact/enterprise-support.ec.html), requesting a new Click Tracking Domain and CNAME proxy to Branch
...
## Enable Adobe Campaign## Connect Adobe Campaign Classic in Branch
...
The Adobe Campaign Classic integration requires you to provide the following:

- **Click Tracking Domain** - The domain you use with Adobe Campaign Classic for links in emails
- **The mid-sourcing instance URL** - The domain Adobe Campaign Classic uses to collect data.
...
```
<ahref="links.example.com?$deep_link=true">Link to your app!</a>
```
...
```
<ahref="links.example.com?$web_only=true">Link to your app!</a>
```
