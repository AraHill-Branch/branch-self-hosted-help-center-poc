...
- **New Users** please use our server-side data integration with Segment to either [import Segment data into Branch](segment-import.md) or [export Branch Data into Segment](segment-export.md).