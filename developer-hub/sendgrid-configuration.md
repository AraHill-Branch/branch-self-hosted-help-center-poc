...
Effortless Email. Partner with the communication platform trusted by developers and marketers for time savings, scalability, and delivery expertise.
...
- Developers
- CRM/Email Team
- Sendgrid Account Manager / Support Team
:::

In order to enable Sendgrid, you must first:
...
5. Obtain or set up your Sendgrid **click tracking domain** (CTD). Reach out to your Sendgrid account manager for assistance on this.

## Enable Sendgrid

### Connect Sendgrid Service in Branch Dashboard
...
The Sendgrid integration requires you provide the following:

- **Click Tracking Domain** - The domain you use with Sendgrid for links in emails
...
### Add your Sendgrid CTD to your Associated Domains
