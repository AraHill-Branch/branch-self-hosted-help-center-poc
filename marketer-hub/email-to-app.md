...
4. If user doesn't have the app installed:  
    a. Route user to App/Play store to download the app and routes to relevant content on app open.  
    b. Route user to mobile web relevant content

## Access

Branch Email is available as part of our Engagement product. Learn more on our [pricing](packaging.md) page.

## Integration Guide

The integration changes depending on which email service provider you are using. Please follow the [Branch Email Integration Guide](universal-email-integration-guide.md) for your specific email service provider.