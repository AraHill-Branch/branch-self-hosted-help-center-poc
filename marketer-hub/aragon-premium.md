---
title: "Aragon Premium"
slug: aragon-premium
---

## Overview

![](/img/484fbaa-logo-transparent-horizontal(1).png "logo-transparent-horizontal.png")

[Aragon Premium](https://aragonpremium.com/) is a division of Aragon Advertising focused on cost-per-acquisition marketing through content, influencers, communities, email, loyalty, and mobile in-app display. We provide transparency into acquisition costs and visibility into all link placements, ensuring brands who partner with Aragon Premium receive valuable insights into where and how they are succeeding.
...
3. Search for Aragon Premium.
4. Select **Aragon Premium**, and click **Save & Enable**.

   ![](/img/232ded4-aragon-enable(1).png "aragon-enable.png")
...
![](/img/1325f2f-aragon-pb(1).png "aragon-pb.png")
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, Aragon Premium provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.

Below are the link parameters that Branch automatically appends for this ad partner:

![](/img/7f54fc7-aragon-link(1).png "aragon-link.png")
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable Aragon Premium, Branch uses the attribution windows you've selected at the app level.

However, you can choose to use the attribution windows provided specifically by Aragon Premium. To do so, toggle the **Use Ad Partner Attribution Windows** to on. Please keep in mind that only conversions attributed to this ad partner will use these specific windows; otherwise, the app-level windows prevail.

![](/img/a1000ac-Screen_Shot_2020-12-14_at_3.26.50_PM(1).png "Screen Shot 2020-12-14 at 3.26.50 PM.png")
...
![](/img/71b961b-aragon-testing-pb(1).png "aragon-testing-pb.png")
