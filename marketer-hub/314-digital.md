...
| --- | --- |
| Company Type | - Ad Network - Affiliate Network - DSP - Incentive - Non Incentive - Publisher |
| Deep Linking | Supported |
| Attribution | - Click-Through Attribution |
| Ad Campaign Types | - Acquisition campaigns |
| Ad Formats | - Banner - Interstitial - Video - Recommendation |
...
Talk to your Account Manager at 2.14 Digital to learn how to access your Goal ID.
:::
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, 3.14 Digital provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable 3.14 Digital, Branch uses the attribution windows you've selected at the app level.
