...
Using Branch you can have deeper insights into engagement with consumers, not just clicks, but also application installs, opens, purchase etc. Driving your customers into the app will significantly increase user engagement as demonstrated in case studies from [Airbnb](https://cdn.us.document360.io/082e8be0-ad38-4650-9062-689a75e517a2/Images/Documentation/CS-Airbnb.pdf) and [Instacart](https://cdn.us.document360.io/082e8be0-ad38-4650-9062-689a75e517a2/Images/Documentation/CS-Instacart-DLE.pdf), who are already using Branch Links in their emails.
...
**Click Flow with Branch Email Integration**



**Click Flow with Branch Email for Integrations that Always Open the App**



## Access

Access to Branch Email is included in our Engagement product. Learn more on our [pricing](packaging.md) page.

## More information

For more detailed information on integrating Email with Branch, visit our [developer documentation](email.md).