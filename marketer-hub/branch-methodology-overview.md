---
title: "Branch Methodology Overview"
slug: branch-methodology-overview
---
...
The Branch Web SDK is used for web-to-app use cases and attribution for conversions that happen on mobile web. See our [developer documentation](web-sdk-overview.md) for implementation details.
