...
![](/img/b2c71de-f50869c-cashslide.png "f50869c-cashslide.png")

[Cashslide](http://www.cashslide.co.kr/) is mobile advertisement media that works on Android lock screens. It delivers diverse types of advertisements to users on an hourly basis. Users can get rewards from Cashslide.

**PARTNER CAPABILITIES**

| Partner Capabilities | Details |
| --- | --- |
| Company Type | Contact support at CashSlide for more information. |
| Deep Linking | Supported |
| Attribution | Contact support at CashSlide for more information. |
| Ad Campaign Types | Contact support at CashSlide for more information. |
| Ad Formats | Contact support at CashSlide for more information. |
| Click Types | Contact support at CashSlide for more information. |
| Supported Platforms | - Android |
| Link Wrapping | Contact support at CashSlide for more information. |
| Cost Ingestion Support | Contact support at CashSlide for more information. |
| Cost Ingestion Types | Contact support at CashSlide for more information. |
...
3. Search for Cashslide.
4. Select **Cashslide**, and click **Save & Enable**.

   ![](/img/e889df7-cashslide-enable.png "cashslide-enable.png")
...
![](/img/ae8f451-cashslide-pb.png "cashslide-pb.png")
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, CashSlide provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.

Below are the link parameters that Branch automatically appends for this ad partner:

![](/img/e475804-cashslide-link.png "cashslide-link.png")
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable CashSlide, Branch uses the attribution windows you've selected at the app level.

However, you can choose to use the attribution windows provided specifically by CashSlide. To do so, toggle the **Use Ad Partner Attribution Windows** to on. Please keep in mind that only conversions attributed to this ad partner will use these specific windows; otherwise, the app-level windows prevail.

![](/img/383eee7-cashslide-attr.png "cashslide-attr.png")
...
![](/img/be7b9b3-cashslide-pb-testing.png "cashslide-pb-testing.png")
