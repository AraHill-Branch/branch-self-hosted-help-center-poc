...
![](/img/8db2026-adperio_logo.png "adperio_logo.png")

[Adperio](https://www.performcb.com/adperio/) drives mobile app installs with high levels of engagement and retention, while protecting ad spend through proprietary fraud prevention technology.

Looking beyond the install, Adperio aligns quality and scale to leverage data and deliver their clients targeted users that continue to engage. Adperio provides developers, brands, and top agencies with unmatched expertise in mobile app marketing. In doing so, Adperio generates installs to reach their client's KPIs; working across channels such as video, in-app, incent, influencer, pre-installs, and display. To learn more about Adperio, please visit [www.adperio.com](http://www.adperio.com).

**PARTNER CAPABILITIES**

| Partner Capabilities | Details |
| --- | --- |
| Company Type | - Ad Network - Affiliate Network - Incentive - Non Incentive |
...
3. Search for **Adperio**
4. Select **Adperio** and click **Save & Enable**.

   ![](/img/482ea3d-enable-adperio.png "enable-adperio.png")
...
![](/img/fff1ba3-Adperio_postback_config.png "Adperio_postback_config.png")
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, Adperio provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.

Below are the link parameters that Branch automatically appends for this ad partner:

![](/img/b133cbd-adperio_link_param.png "adperio_link_param.png")
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable Adperio, Branch uses the attribution windows you've selected at the app level.

However, you can choose to use the attribution windows provided specifically by Adperio. To do so, toggle the **Use Ad Partner Attribution Windows** to on. Please keep in mind that only conversions attributed to this ad partner will use these specific windows; otherwise, the app-level windows prevail.

![](/img/f4f8cf1-adperio_attribution.png "adperio_attribution.png")
...
![](/img/7c2da48-adperio_postback_testing.png "adperio_postback_testing.png")
