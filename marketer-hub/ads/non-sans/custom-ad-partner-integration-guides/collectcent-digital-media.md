...
slug: collectcent-digital-media
---
...
| --- | --- |
| Company Type | - Ad Network - Agency - DSP - Non-Incentive - Publisher - RTB - Self Serve |
| Deep Linking | Supported |
| Attribution | - Click-Through Attribution |
| Ad Campaign Types | - Acquisition campaigns |
| Ad Formats | Contact support at Collectcent Digital Media for more information. |
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, Collectcent Digital Media provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable Collectcent Digital Media, Branch uses the attribution windows you've selected at the app level.
