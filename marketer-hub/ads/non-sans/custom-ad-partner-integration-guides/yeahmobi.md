...
| --- | --- |
| Company Type | Contact support at Yeahmobi for more information. |
| Deep Linking | Supported |
| Attribution | - Click-Through Attribution |
| Ad Campaign Types | Contact support at Yeahmobi for more information. |
| Ad Formats | Contact support at Yeahmobi for more information. |
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, Yeahmobi provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable Yeahmobi, Branch uses the attribution windows you've selected at the app level.
