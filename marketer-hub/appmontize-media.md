---
title: "Appmontize Media"
slug: appmontize-media
---

## Overview

![](/img/ca9ba1f-appmonitize-media-logo(1).png "appmonitize-media-logo.png")

We are an adtech company based out of India, we have our own traffic for mobile and desktop on banner, Native, video and push Notifications.

**PARTNER CAPABILITIES**

| Partner Capabilities | Details |
| --- | --- |
| Company Type | - Ad Network - Affiliate - DSP - Exchange - Publisher - RTB - Self Serve |
| Deep Linking | Supported |
| Attribution | - Click-through - View-through |
| Ad Campaign Types | - Acquisition - Retargeting |
| Ad Formats | - Banner - Interstitial - Video - Recommendation - App of the Day |
| Click Types | - Client-side Click |
| Supported Platforms | - iOS - Android |
| Link Wrapping | Supported |
| Cost Ingestion Support | Not Supported |
| Cost Ingestion Types | N/A |
| Pricing Models | - CPI - CPM - CPA - CPV |
...
3. Search for App Monetize Media.
4. Select **App Monetize Media**, and click **Save & Enable**.

   ![](/img/60c0bdb-4fd8399-Screenshot_2020-11-27_231551(1).png "4fd8399-Screenshot_2020-11-27_231551.png")
...
![](/img/735bd11-117c48e-Appmontize_Media_POSTBACK_CONFIG(1).png "117c48e-Appmontize_Media_POSTBACK_CONFIG.png")
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, Appmontize Media provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.

Below are the link parameters that Branch automatically appends for this ad partner:

![](/img/603ee1a-2a9d89c-Appmontize_Media_LINK_PARAMETERS(1).png "2a9d89c-Appmontize_Media_LINK_PARAMETERS.png")
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable Appmontize Media, Branch uses the attribution windows you've selected at the app level.

However, you can choose to use the attribution windows provided specifically by Appmontize Media. To do so, toggle the **Use Ad Partner Attribution Windows** to on. Please keep in mind that only conversions attributed to this ad partner will use these specific windows; otherwise, the app-level windows prevail.

![](/img/c19df5e-Screen_Shot_2020-12-14_at_3.24.22_PM(1).png "Screen Shot 2020-12-14 at 3.24.22 PM.png")
...
![](/img/5e38ce8-bbf9738-Appmontize_Media_POSTBACK_TESTING(1).png "bbf9738-Appmontize_Media_POSTBACK_TESTING.png")
