...
| Cost Ingestion Types | Contact support at PARTNER for more information. |
...
[Learn more here on how to reset your ad partner's settings.](https://help.branch.io/faq/docs/reset-my-ad-partners-settings)
:::
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, InMobi DSP provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable InMobi DSP, Branch uses the attribution windows you've selected at the app level.
