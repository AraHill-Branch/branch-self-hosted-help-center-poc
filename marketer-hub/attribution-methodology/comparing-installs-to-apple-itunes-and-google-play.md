---
title: "Compare Installs to Apple iTunes and Google Play"
slug: comparing-installs-to-apple-itunes-and-google-play
---
...
- Users may download the app, but may not run it or may run it after a [look-back period](attribution-windows-link-settings.md) expires from the click.
