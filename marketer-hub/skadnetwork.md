---
title: "SKAdNetwork Overview"
slug: skadnetwork
---

## Overview

[SKAdNetwork](https://developer.apple.com/documentation/storekit/skadnetwork) (SKAN) is Apple’s attribution framework on iOS, providing accurate attribution data to help marketers understand and refine mobile ad campaigns. By concealing details like user-level identifiers that could cause other companies to exploit that data without user consent, SKAdNetwork is the leading attribution framework prioritizing user privacy and security.

### Ad Network Support

<details>
<summary>CLICK HERE TO SEARCH FOR YOUR SKADNETWORK SUPPORTED NETWORKS</summary>
...
| Facebook | [View Facebook Specific Guide](facebook-skadnetwork.md) |
...
| Google | [View the Google Adwords Specific Guide](google-skadnetwork.md) |
...
| Snap | [View the Snap Specific Guide](snap.md) |
| Sportradar | ✅ Forwards individual SKAN postbacks to Branch |
...
| TikTok For Business | [View the TikTok for Business Specific Guide](tiktok-skadnetwork.md) |
...
| Postback Sequence Index | SKAN 4 and later. The possible integer values of 0, 1, and 2 signify the order of postbacks that result from the three conversion windows. For more information, see Apple's [Receiving postbacks in multiple conversion windows](https://developer.apple.com/documentation/storekit/skadnetwork/receiving_postbacks_in_multiple_conversion_windows). | ✅ | ✅ |
...
| [mParticle iOS](https://github.com/BranchMetrics/mparticle-for-ios-branch) | `v.8.0.0` | `v8.1.0` |
| [Adobe Launch iOS](https://github.com/BranchMetrics/AdobeBranchExtension-iOS) | `v.1.3.0` | `v2.0.0` |
| [Cordova](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking-attribution) | `v.4.2.0` | `v6.0.0` |
| [Capacitor](https://github.com/BranchMetrics/capacitor-branch-deep-links) | `v.2.0.0` | `v6.0.0` |
| [Xamarin](https://github.com/BranchMetrics/xamarin-branch-deep-linking-attribution) | `v.7.0.6` | `v8.1.2` |
| [Unity](https://github.com/BranchMetrics/unity-branch-deep-linking-attribution) | `v.0.6.6` | Not yet supported |
| [Flutter](https://github.com/RodrigoSMarques/flutter_branch_sdk) | `v.1.1.0` | `v6.5.0` |
...
6. For the events, Apple reports a conversion value from 0-63, which the advertiser can set to give some estimates on the users' quality; SKAN 4.0 can send [additional granularity](skadnetwork-data.md#postback-data-tiers).
...
::: info SKAdNetwork with Self-Attributing Networks
SKAdNetwork works a little bit differently based on the Self-Attributing Network (SAN). See the individual SAN guides here:

- [Google](google-skadnetwork.md)
- [Facebook](facebook-skadnetwork.md)
- [Snap](snap.md)
- [TikTok For Business](tiktok-skadnetwork.md)
:::