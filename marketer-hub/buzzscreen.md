...
| --- | --- |
| Company Type | Contact support at BuzzScreen for more information. |
| Deep Linking | Supported |
| Attribution | Contact support at BuzzScreen for more information. |
| Ad Campaign Types | Contact support at BuzzScreen for more information. |
| Ad Formats | Contact support at BuzzScreen for more information. |
| Click Types | Contact support at BuzzScreen for more information. |
| Supported Platforms | - iOS - Android - Amazon - Windows |
| Link Wrapping | Contact support at BuzzScreen for more information. |
| Cost Ingestion Support | Contact support at BuzzScreen for more information. |
| Cost Ingestion Types | Contact support at BuzzScreen for more information. |
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, BuzzScreen provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable BuzzScreen, Branch uses the attribution windows you've selected at the app level.
