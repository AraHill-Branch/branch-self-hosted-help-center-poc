---
title: "Create App Links"
slug: create-app-links
---

::: info Attention
[New Branch](https://help.branch.io/docs/create-app-links-new) is now available for some users, your experience may differ.
:::

## Overview

App links are Branch Links that take your users to app destinations. There are four primary methods you can use to create app links:

- Method 1: Create app Short Links in the Branch Dashboard
- Method 2: Create bulk app Short Links in the Branch Dashboard
...
You can set up a custom domain (for example, link.yourbrand.com) in the Branch Dashboard. Read our [Advanced Settings & Changing Link Domain](advanced-settings-configuration.md) article to learn how.  
...
You can create app Short Links in bulk in the Branch Dashboard.
...
### Method 4: App links through the Deep Linking API
...
Check out our [Deep Link Reference](creating-a-deep-link.md), [LinkHub](linkhub.md), and [Link Validator](link-validator.md) articles to continue learning about app links.
