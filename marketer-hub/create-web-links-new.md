---
title: "Create Web Links (New)"
slug: create-web-links-new
---

## Overview

::: info Note
The information in this article is relevant to the Activation product. If you want information about web link creation for the Engagement product, read our [Legacy Web Link Creation](legacy-link-creation.md) article.
:::
...
- [Method 1: Create web Short Links in Branch](create-web-links-1.md#method-1-create-short-links-in-the-branch-dashboard)
- [Method 2: Create bulk web Short Links in Branch](create-web-links-1.md#method-2-create-bulk-short-links-in-the-branch-dashboard)
- [Method 3: Create Short Links in the Branch Slack App](create-web-links-1.md#method-3-create-short-links-in-the-branch-slack-app)
- [Method 4: Create web links through the Deep Linking API](create-web-links-1.md#method-4-create-web-links-through-the-deep-linking-api)
- [Method 5: Create Short Links using Ivy](create-web-links-1.md#method-5-create-short-links-with-ivy)
...
Read our [Create App Links](create-app-links.md) article to learn more about app links.
...
You can set up a custom domain (for example, link.yourbrand.com) in the Branch Dashboard. Visit our [Basic Link Configuration](basic-link-configuration.md#5-link-domain) guide to learn how.  
...
::: info Note
Switching between web-only and app routing may change the link URL depending on your package and domain configuration. If this link will be used in print, finalize your routing strategy before distribution. See [Create QR Codes](https://help.branch.io/marketer-hub/docs/create-qr-codes) for details.
:::
...
You can create web Short Links using the Branch Slack App. Read our [Branch Slack App](branch-slack-app.md) article to learn more.
...
You can use the Links page to manage and view your Short Links. Learn more in our [Links Page](linkhub.md) article. With Activation you’ll see separate **Web Short Links** and **App Short Links** tabs.
...
On the Links page, you can view how many clicks your links have received. Select the **Clicks** column in the table to sort by most clicks or least clicks. You can learn more in our [Links Page](linkhub.md) article.
