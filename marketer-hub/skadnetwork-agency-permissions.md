---
title: "SKAdNetwork Agency Permissions"
slug: skadnetwork-agency-permissions
---
...
1. [Agency access is already set up](add-agency-to-your-account.md) for your Branch Dashboard
2. [Admin](add-manage-users-roles-permissions-access.md) access to your Branch Dashboard
:::

1. In the Branch Dashboard, navigate to the Agency Permissions in the [SKAdNetwork Configuration](https://dashboard.branch.io/ads/skadnetwork/configuration)  
