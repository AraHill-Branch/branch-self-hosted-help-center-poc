...
| --- | --- |
| Company Type | Contact support at Rakuten Marketing for more information. |
| Deep Linking | Supported |
| Attribution | - Click-Through Attribution |
| Ad Campaign Types | - Acquisition campaigns - Retargeting campaigns |
| Ad Formats | Contact support at Rakuten Marketing for more information. |
...
By default, Branch automatically appends partner-specific link parameters during the link creation process. When a user clicks on the link, Rakuten Marketing provides the appropriate parameter values which Branch ingests and uses for attribution and reporting purposes.
...
Branch employs [Attribution Windows](attribution-windows-link-settings.md) at both the app level and the ad partner level. When you enable Rakuten Marketing, Branch uses the attribution windows you've selected at the app level.
