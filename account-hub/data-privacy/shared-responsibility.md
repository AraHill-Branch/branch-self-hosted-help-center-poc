...
Branch provides an industry leading mobile linking and measurement platform that unifies user experiences and attribution across devices, platforms, and channels. We understand the inherent risks of operating our **Service** in a digital landscape where cyber attackers are looking for opportunities to compromise data.

We operate our Service under a shared responsibility model by which the responsibility for certain security and compliance elements is shared between us and our customers. We provide appropriate technical and organizational measures to ensure the security and privacy of the Service infrastructure.

**You are responsible for your implementation of the Service** and configuration of the security, privacy, and retention settings within the Service.

If you can control a parameter within the Services, then **you are responsible for ensuring it is configured to meet your compliance needs**.

This shared responsibility model enables us to provide you with a Service that can be configured to empower our most security conscious customers to enhance their end users' experience and improve measurement performance across their business.

Our commitment to providing a secure experience for our customers works in tandem with your responsibility for adhering to certain standards and practices as a subscriber to the Service as further outlined below.
...
- **Understand where data may be shared with a third party** through an integration or other optional configuration, and treat such channels or configurations in accordance with your security policies and approved use cases.
- **Monitor all activity within your instance** of the Service including timely review of audit logs.
- **Notify Branch immediately when you become aware of, or suspect that a security vulnerability exists**, or that a data breach or security incident involving the Service has occurred or is likely to occur.
- **Promote the secure deployment and maintenance of all third-party integrations** you configure within the Service and ensure continuous monitoring and incident response on customer and third-party integration assets.
- **Maintain and apply security updates**, patches, and fraud detection and prevention measures to your own infrastructure used to access the Service.
...
- [Branch Quick Start Guide](quick-start-guide-for-implementing-branch.md)
- [User Permissions and Management](entity-views-access-controls-overview.md)
- [Data Privacy](best-practices-to-avoid-sending-pii-to-branch.md)
- [Data Integration Implementation Guide](data-integration-implementation-guide.md)
- [Data Integration Partners](data-integration-partners.md)
- [Fraud Prevention](in-depth-fraud-recommendations.md)
- [Account Settings](enable-single-sign-on.md)

#### Branch Legal Center

- [Branch Subprocessors](https://legal.branch.io/#third-party-list)

#### Branch website

- [Branch Security](https://www.branch.io/security/)