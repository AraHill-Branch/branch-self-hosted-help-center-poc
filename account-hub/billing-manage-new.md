...
| --- | --- |
| - Your Plan - Usage Statistics - Subscribed Products | **View** access to **App-level Settings** |
| - Payment Info (credit cards) - View/download invoices - Billing contact info | **View** access to **App-level Settings** and **Sensitive Data** |
...
The **Billing** tab is an overview of your Branch plan, including:

- The Branch [products, features, and add-ons](products.md) that are part of your plan
...
The **Payment information** module is where you can see what payment method is being used for this Branch account.

You can use the **Edit** button to make changes to your payment information.

### Estimated upcoming bill

The **Estimated upcoming bill** module gives you an estimated projection of your upcoming invoice amount, and when it will be billed.
