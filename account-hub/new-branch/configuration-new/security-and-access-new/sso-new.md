...
Choose an SSO guide to follow based on which IdP you use:

- [Okta](configure-sso-with-okta.md)
- [Azure](configure-sso-with-azure.md)
- [Google](configure-sso-with-google.md)

If you don't use one of these IdPs, follow our [General SAML](configure-sso.md) guide.