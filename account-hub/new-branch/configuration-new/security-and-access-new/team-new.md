...
You can access this page by navigating to **Configuration > Security & Access >** [**Team**](https://branchdocs.app.link/security-access-team) in Branch.
...
1. Navigate to **Configuration > Security & Access >** [**Team**](https://branchdocs.app.link/security-access-team).
...
5. Select the appropriate [access level](default-access-levels-users-roles-permissions.md) from the **Access level** dropdown.
...
::: danger Warning
Removing a team member immediately revokes their access to your Branch account. They'll no longer be able to log in or access any Branch data or settings. This action can't be undone, but you can re-invite the user if needed.
:::
