...
To submit a ticket to Branch, visit our [Support portal](https://support.branch.io/hc/en-us/requests/new).

You'll be given the option to submit one of the following types of inquiries:
...
Standard Support is available to answer questions via email **during business hours only**.

Business hours vary depending on the timezone.

Our business hours are listed below:

- **ANZ** Business Hours: 9 AM - 5 PM (Sydney Time)
- **NEA** Business Hours: 9 AM - 5 PM (Seoul Time)
- **SEA** Business Hours: 9 AM - 5 PM (Singapore Time)
- **India** Business Hours: 9 AM - 5 PM (Bangalore Time)
- **EMEA** Business Hours: 9 AM - 5 PM (London Time)
- **NA** Business Hours: 9 AM - 5 PM (Pacific Time US & Canada)

## SLAs

Our Response Time Service Level Agreements (SLAs) are defined by your package and are subject to change. Branch's current initial response SLAs can be found below:
...
Note that SLA times do **not** apply to self-serve customers.

## Best practices

Below are some best practices when reporting an issue.

- Include your Branch App ID with your support ticket. You can find your App ID in [Branch](https://dashboard.branch.io/account-settings/profile) by navigating to **Account Settings > Profile**.
- Include steps to reproduce the issue, error messages, and any screenshots whenever applicable to help us expedite our investigation.
- If you're an Ad Partner or an Agency reaching out to us about a specific campaign, provide us with the tracking link and details about the campaign/customer app.
- If the issue is related to your app code, send us code snippets whenever applicable.
- When reporting a new issue, start a new email thread; using an old email thread for a different ticket could delay response.
- Reply to the auto-response you receive when a new ticket is created to add additional information to the ticket.